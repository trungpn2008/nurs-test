...
{{--                                            <div class="avatar">--}}
{{--                                                <img src="/images/admin/avatars/1.png" alt class="w-px-40 h-auto rounded-circle">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                        <div class="flex-shrink-0 me-3">--}}
{{--                                            <div class="avatar">--}}
{{--                                                <img src="/images/admin/avatars/2.png" alt class="w-px-40 h-auto rounded-circle">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="flex-grow-1">--}}
...
{{--                                        <div class="flex-shrink-0 me-3">--}}
{{--                                            <div class="avatar">--}}
{{--                                                <img src="/images/admin/avatars/9.png" alt class="w-px-40 h-auto rounded-circle">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="flex-grow-1">--}}
...
{{--                                        <div class="flex-shrink-0 me-3">--}}
{{--                                            <div class="avatar">--}}
{{--                                                <img src="/images/admin/avatars/5.png" alt class="w-px-40 h-auto rounded-circle">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="flex-grow-1">--}}
...
{{--                                        <div class="flex-shrink-0 me-3">--}}
{{--                                            <div class="avatar">--}}
{{--                                                <img src="/images/admin/avatars/6.png" alt class="w-px-40 h-auto rounded-circle">--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="flex-grow-1">--}}
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            <img src="/images/admin/avatars/1.png" alt class="rounded-circle">
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
