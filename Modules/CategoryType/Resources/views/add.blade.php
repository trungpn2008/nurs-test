...
@section('content')
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">CategoryType /</span> Add
    </h4>
    <div class="box-content">
        <div class="card mb-4">
        <h5 class="card-header">Tạo category type</h5>
        <form id="form-category-type" class="card-body" method="post" action="" enctype="application/x-www-form-urlencoded">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="code" name="code" class="form-control" placeholder="Mã" />
                </div>
            </div>
            <hr class="my-4 mx-n4" />
            <div class="pt-4">
