...
@section('content')
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">Recruitment /</span> Create
    </h4>
    <div class="box-content">
        <div class="card mb-4">
        <h5 class="card-header">Tạo Recruitment</h5>
...
{{--            <h6 class="fw-normal">1. Thông tin cấu hình</h6>--}}
            <div class="row g-3">
                ...
                <div class="col-md-5">
                    ...
                    <input type="number" id="number" name="number" class="form-control" placeholder="Số lượng" />
                </div>
                <div class="col-md-1">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="file" id="ckfinder-input-image"
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <input class="form-control" type="date" name="time_end" id="time-end-datetime" />
                    </div>
                </div>
                <div class="col-md-12">
