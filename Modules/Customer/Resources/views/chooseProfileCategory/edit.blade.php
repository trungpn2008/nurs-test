...
@section('content')
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">Choose Profile Category /</span> Edit
    </h4>
    <div class="box-content">
        <div class="card mb-4">
        <h5 class="card-header">Sửa Choose Profile Category</h5>
        <form id="form-category-type" class="card-body" method="post" action="" enctype="application/x-www-form-urlencoded">
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <input type="text" id="title" name="title" class="form-control" placeholder="Tiêu đề" value="{{$chooseProfileCategory->title}}" />
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="name_input">Name Input</label>
                    <input type="text" id="name_input" name="name_input" class="form-control" placeholder="Name Input" value="{{$chooseProfileCategory->name_input}}" />
                </div>
                <div class="col-md-1">
                    <label class="form-label" for="requiredChecked">required</label>
                    <div class="form-check form-switch mb-2" style="padding-top: 5px;">
                        <input class="form-check-input" name="required" type="checkbox" id="requiredChecked" @if ($chooseProfileCategory->required == 1) checked @endif >
                    </div>
                </div>
                <div class="col-md-1">
                    <label class="form-label" for="flexSwitchCheckChecked">Trạng thái</label>
                    <div class="form-check form-switch mb-2" style="padding-top: 5px;">
                        <input class="form-check-input" name="status" type="checkbox" id="flexSwitchCheckChecked" @if ($chooseProfileCategory->status == 1) checked @endif >
                    </div>
                </div>
            </div>
            <hr class="my-4 mx-n4" />
