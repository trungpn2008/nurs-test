...
@section('content')
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">Term And Condition /</span> Edit
    </h4>
        ...
        <form id="form-category-type" class="card-body" method="post" action="" enctype="application/x-www-form-urlencoded">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="title" name="title" class="form-control" placeholder="Tiêu đề" value="{{$termAndCondition->title}}" />
                </div>
                <div class="col-md-6">
                    ...
                    <select id="category_action" name="category_id" class="form-select" data-allow-clear="true">
                        ...
                        @if($termAndCondition->category_id)
                            <option value="{{$termAndCondition->category_id}}" selected="selected">{{$termAndCondition->title_cate}}</option>
                        @endif
                    </select>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="content">Content</label>
                    <textarea name="content" id="content"  class="form-control" placeholder="Content" cols="30" rows="10" hidden>{{$termAndCondition->content}}</textarea>
                </div>
            </div>
            <hr class="my-4 mx-n4" />
            <div class="pt-4">
