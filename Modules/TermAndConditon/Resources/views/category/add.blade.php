...
@section('content')
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">Term And Condition Category /</span> Add
    </h4>
        ...
        <form id="form-category-type" class="card-body" method="post" action="" enctype="application/x-www-form-urlencoded">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="description"  class="form-control" placeholder="Content" cols="30" rows="10" hidden></textarea>
                </div>
            </div>
            <hr class="my-4 mx-n4" />
            <div class="pt-4">
...
<script src="/libs/flatpickr/flatpickr.js"></script>
    ...
    <script>
        ...
        sidebarMenu('TermAndConditionCategories', 'add');
    </script>
@endsection
