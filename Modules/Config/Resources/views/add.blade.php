                ...
                <div class="col-md-6">
                    <div class="form-password-toggle">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" id="alias" name="alias" class="form-control" placeholder="Alias" aria-describedby="multicol-password2" />
