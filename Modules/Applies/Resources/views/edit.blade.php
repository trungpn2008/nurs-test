        ...
        <form class="card-body" method="post" action="" enctype="application/x-www-form-urlencoded">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="title" name="title" class="form-control" placeholder="Tiêu đề" value="{{$applies->title}}" />
                </div>
                <div class="col-md-6">
                    ...
                    <div class="">
                        <select id="category_id" name="category_id" class="select2 form-select" data-allow-clear="true">
                            ...
                            <option value="1" @if ($applies->category_id == 1) selected @endif>Australia</option>
                            <option value="2" @if ($applies->category_id == 2) selected @endif>Bangladesh</option>
                ...
                <div class="col-md-6">
                    <div class="form-password-toggle">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" id="alias" name="alias" class="form-control" placeholder="Alias" value="{{$applies->alias}}" aria-describedby="multicol-password2" />
{{--                            <span class="input-group-text cursor-pointer" id="multicol-password2"><i class="bx bx-hide"></i></span>--}}
                ...
                <div class="col-md-6">
                    <div class="form-password-toggle">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="number" id="arrange" name="arrange" class="form-control" placeholder="Vị trí" value="{{$applies->arrange}}" aria-describedby="multicol-confirm-password2" />
{{--                            <span class="input-group-text cursor-pointer" id="multicol-confirm-password2"><i class="bx bx-hide"></i></span>--}}
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <textarea name="short_description" id="short_description"  class="form-control" placeholder="Mô tả ngắn" cols="30" rows="10">{{$applies->short_description}}</textarea>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="note">Ghi chú</label>
                    <textarea name="note" id="note"  class="form-control" placeholder="Ghi chú" cols="30" rows="10">{{$applies->note}}</textarea>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="image" id="ckfinder-input-image" value="{{$applies->image}}"
                                   class="form-control"><span class="input-group-btn">
                                <a id="ckfinder-popup-image" class="btn btn-primary">Chọn</a></span>
                        </div>
                    </div>
                    @if($applies->image)
                        <img src="{{$applies->image}}" width="100%" style="padding-top: 10px">
                    @endif
                </div>
                <div class="col-md-6 select2-primary">
                    <label class="form-label" for="hashtag">Hashtag</label>
                    <select id="hashtag" name="hashtag" class="select2 form-select" multiple>
                        <option value="en" @if($applies->hashtag == 'en') selected @endif>English</option>
                        <option value="fr" @if($applies->hashtag == 'fr') selected @endif>French</option>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="description"  class="form-control" placeholder="Nội dung bài viết" cols="30" rows="10">{{$applies->description}}</textarea>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="source">Nguồn</label>
                    <input type="text" id="source" name="source" class="form-control" value="{{$applies->source}}" placeholder="Nguồn" />
                </div>
            </div>
            <div class="pt-4">
