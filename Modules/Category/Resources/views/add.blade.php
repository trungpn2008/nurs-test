                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="number" id="arrange" name="arrange" class="form-control" placeholder="Vị trí" aria-describedby="multicol-confirm-password2" />
                    ...
                    <div class="col-md-12">
                        <div class="form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="url_location" name="url_location" class="form-control" placeholder="Vị trí" aria-describedby="multicol-confirm-password2" />
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" id="text_image" name="text_image" class="form-control" placeholder="Text ảnh" />
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-label" for="ckfinder-input-image">Ảnh</label>
                            <div class="input-group">
                                <input type="text" name="image" id="ckfinder-input-image"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="icon" id="ckfinder-input-icon"
                                       class="form-control"><span class="input-group-btn">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            get_categorys({
                ...
                url: '{{ route("admin.category.ajax-get-category") }}',
                data_id: 'id',
                data_text: 'text',
