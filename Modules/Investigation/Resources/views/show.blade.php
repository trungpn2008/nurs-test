...
@section('content')
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">Investigation /</span> Edit
    </h4>
    <div class="box-content">
        <div class="card mb-4">
        <h5 class="card-header">Show Investigation</h5>
        <form id="form-category-type" class="card-body" method="post" action="" enctype="application/x-www-form-urlencoded">
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <p class="fw-bolder">{{$investigation->name}}</p>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="email">Email</label>
                    <p class="fw-bolder">{{$investigation->email}}</p>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="email">Question</label>
                    <p class="fw-bolder">{{$investigation->question}}</p>
                </div>
            </div>
{{--            <hr class="my-4 mx-n4" />--}}
{{--            <div class="pt-4">--}}
